        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input id="firstName" required className="bg-white border-gray-300" />
            </div>
            <div className="space-y-2">
              <Label htmlFor="lastName" className="text-gray-700">Last Name</Label>
              <Input id="lastName" required className="bg-white border-gray-300" />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input id="subject" required className="bg-white border-gray-300" />
          </div>
