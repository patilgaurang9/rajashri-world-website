          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-gray-600">Thane, Maharashtra, India</div>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-gray-600">+91 9226559359/ 8369979137</div>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-gray-600">rajashriworld711@gmail.com</div>
              </div>
            </div>
            {/* <div className="flex items-start gap-3">
